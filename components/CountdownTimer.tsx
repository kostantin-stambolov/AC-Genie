    ...
    <div className={`inline-flex items-center gap-3 rounded-2xl px-4 py-2.5 ring-1 ${bgClass} ${ringClass}`}>
      <div className="relative w-8 h-8 shrink-0">
        <svg viewBox="0 0 36 36" className="w-8 h-8 -rotate-90">
          <circle cx="18" cy="18" r="15" fill="none" stroke="currentColor" strokeWidth="3" className="text-[#E5E7EB]" />
          <circle
      ...
      <div>
        <p className={`text-[20px] font-bold leading-none tabular-nums ${colorClass}`}>{display}</p>
